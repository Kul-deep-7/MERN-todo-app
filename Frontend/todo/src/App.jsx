...
//okay as SetTodos have response.data.data it have access to mongo DB's document si we can use todo._id & todo.text for map to show on UI        
  ...
  <div>
    {todos.filter(Boolean).map((todo) => ( // filter(Boolean) removes undefined/null
      <div key={todo._id}>
        {editingTodo === todo._id ? (
          <div className="flex items-center gap-x-3">
            ...
            <div>
              <button
                className="text-white rounded-lg bg-red-600 hover:bg-red-500 px-4 py-2 cursor-pointer"
